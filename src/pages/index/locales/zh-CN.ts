export default {
  ...
  'dashboard-analysis.analysis.month-total-sales': '月销售额',
  'dashboard-analysis.analysis.day-sales': '日销售额',
  'dashboard-analysis.analysis.visits': '访问量',
  'dashboard-analysis.analysis.new-customers': '新增用户',
  'dashboard-analysis.analysis.new-users': '年新增用户',
  'dashboard-analysis.analysis.visits-trend': '访问量趋势',
  'dashboard-analysis.analysis.new-customers-trend': '新增用户趋势',
  'dashboard-analysis.analysis.visits-ranking': '门店访问量排名',
  'dashboard-analysis.analysis.day-visits': '日访问量',
  'dashboard-analysis.analysis.day-new-users': '当月新增用户',
  'dashboard-analysis.analysis.service-name': '服务类型',
  ...
  'dashboard-analysis.analysis.new-services-total': '新提交服务数',
  'dashboard-analysis.analysis.per-capita-search': '人均搜索次数',
  'dashboard-analysis.analysis.online-top-search': '线上热门搜索',
  'dashboard-analysis.analysis.new-service-submit': '新服务提交',
  ...
  'dashboard-analysis.analysis.month-sales': '月销售额',
  'dashboard-analysis.analysis.traffic': '客流量',
  'dashboard-analysis.table.rank': '排名',
  'dashboard-analysis.table.service-name': '服务类型',
  'dashboard-analysis.table.search-keyword': '搜索关键词',
  'dashboard-analysis.table.service-total': '提交数',
